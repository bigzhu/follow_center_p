...
rsync -rvz --exclude '.git' -e "ssh -p 2222" ../lib_p_bz root@47.88.137.77:/home/bigzhu/
rsync -rvz --exclude '.git' -e "ssh -p 2222" ./* root@47.88.137.77:/home/bigzhu/follow_center_p/
